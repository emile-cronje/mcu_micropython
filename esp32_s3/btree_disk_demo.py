...
#            idList.append(readingIndex)
            ...
            unique_id = index * readingCount + readingIndex  # Creates keys 0,1,2,...,99
            B.insert((unique_id, meterReading.__dict__))
...
result = B.find(-1000)
print("Search unknown: " + str(result))
keyCount = 0

for item in B.traverse_keys():
    keyCount += 1

countAll = B.count_all()

if (countAll != keyCount):
    print(f"Keycount all error..." + str(countAll))
else:
    print(f"Keycount all OK!")    
